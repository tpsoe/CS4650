...
print(df.loc[0 : 10, ['Provider Id', 'Provider Name', 'Provider Street Address']])
...
df2 = pd.read_csv('Inpatient_Prospective_Payment_System__IPPS__Provider_Summary_for_the_Top_100_Diagnosis-Related_Groups__DRG__-_FY2011.csv', index_col = 8)
df2.head(10).boxplot()
df2.head(10).plot(kind= 'bar', stacked = True)

ax = df2.head(10).plot(xticks = range(4), legend=False, style=['r+-','gx-','b*-'], title='My Chart')
ax.set_xlabel('Index')
